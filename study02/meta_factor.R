### Script to run random-effects meta analysis with maximum likelihood for DA-Discounting correlation w/DA status factor
...
# open data
data <- read.csv(file="./meta_data.csv",header=TRUE, sep=",")
